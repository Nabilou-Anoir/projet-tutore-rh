-- ============================================================
-- data-mysql.sql
-- Généré depuis data.sql : compatible MySQL 8
-- Syntaxe H2 (RESTART WITH) retirée.
-- ============================================================
SET NAMES utf8mb4;
...
-- [MySQL] ligne H2 supprimée : ALTER TABLE domaine_competence ALTER COLUMN id RESTART WITH 9;
...
-- [MySQL] ligne H2 supprimée : ALTER TABLE competence ALTER COLUMN id RESTART WITH 40;
...
-- [MySQL] ligne H2 supprimée : ALTER TABLE famille_si ALTER COLUMN id RESTART WITH 1;
-- [MySQL] ligne H2 supprimée : ALTER TABLE competence_si ALTER COLUMN id RESTART WITH 1;
-- [MySQL] ligne H2 supprimée : ALTER TABLE metier_si ALTER COLUMN id RESTART WITH 1;
-- [MySQL] ligne H2 supprimée : ALTER TABLE activite_si ALTER COLUMN id RESTART WITH 1;
